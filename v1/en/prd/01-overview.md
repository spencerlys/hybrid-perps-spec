...
- Platform calculated loss < HL actual loss → delta covered by risk reserve
- Platform calculated loss > HL actual loss → delta becomes platform profit (or returned to user)
